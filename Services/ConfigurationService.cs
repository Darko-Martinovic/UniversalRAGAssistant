    ...
    public class ConfigurationService : IConfigurationService
    {
        public async Task<AppConfiguration> LoadConfigurationAsync()
        {
            try
            {
                ...
                {
                    throw new FileNotFoundException("appsettings.json not found. Please ensure the configuration file exists.");
                }
        ...
        public (string endpoint, string apiKey, string chatDeployment, string embeddingDeployment) LoadAzureOpenAIConfiguration()
        {
            ...
            var chatDeployment = Environment.GetEnvironmentVariable("CHATCOMPLETION_DEPLOYMENTNAME")
                ?? throw new InvalidOperationException("CHATCOMPLETION_DEPLOYMENTNAME not set");

            var embeddingDeployment = Environment.GetEnvironmentVariable("EMBEDDING_DEPLOYMENTNAME")
